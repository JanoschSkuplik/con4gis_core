											   		...
											   		$useMaps=false, $useGoogleMaps=false, $useMapsEditor=false, $useWswgEditor=false, $useScrollpane=false )
	{
   		...
   		{	
   				...
   				(array_search( 'assets/jquery/core/' . JQUERY . '/jquery.min.js|static', $GLOBALS['TL_JAVASCRIPT'] ) !== false))
   			{
				...
				// Include JQuery JS
				$GLOBALS['TL_JAVASCRIPT']['c4g_jquery'] 			= 'system/modules/con4gis_common/lib/jQuery/jquery-1.11.1.min.js';
				// just until the old plugins are replaced
				// $GLOBALS['TL_JAVASCRIPT']['c4g_jquery_migrate']		= 'system/modules/con4gis_common/lib/jQuery/jquery-migrate-1.2.1.min.js';
   		...
   		if ($addJQueryUI || $useTree || $useMaps) 
   		{
			...
			$GLOBALS['TL_JAVASCRIPT']['c4g_jquery_ui'] 		= 'system/modules/con4gis_common/lib/jQuery/ui-1.11.0.custom/jquery-ui.min.js';			
			C4GJQueryGUI::optimizeJSForContao3('c4g_jquery_ui');				
			$GLOBALS['TL_CSS']['c4g_jquery_ui_core'] 		= 'system/modules/con4gis_common/lib/jQuery/ui-1.11.0.custom/jquery-ui.min.css';
			// Set the JQuery UI theme to be used
			if (empty($GLOBALS['TL_CSS']['c4g_jquery_ui'])) {
				$GLOBALS['TL_CSS']['c4g_jquery_ui'] 		= 'system/modules/con4gis_common/lib/jQuery/ui-1.11.0.custom/jquery-ui.theme.min.css';
			}
   		}
		...
		if ($useTable) 
		{
			...
			$GLOBALS['TL_CSS']['c4g_jq_datatables'] 		= 'system/modules/con4gis_common/lib/jQuery/plugins/dataTables/css/jquery.dataTables_themeroller.css';
		}
